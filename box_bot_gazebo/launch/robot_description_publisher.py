...
class RobotDescPub(Node):
    ...
    def __init__(self, args):
        ...
        rclpy.logging.set_logger_level('robot_desciption_pub', rclpy.logging.LoggingSeverity.ERROR)
        ...
        self.publisher_ = self.create_publisher(String, '/robot_description', latched_qos)
